...
CREATE UNIQUE INDEX "UQ_EVENT_PARTICIPANTS_EVENT_USER" ON "event_participants" USING btree ("event_id","user_id");--> statement-breakpoint
CREATE INDEX "messages_sender_created_at_idx" ON "messages" USING btree ("sender_id","created_at");--> statement-breakpoint
CREATE INDEX "messages_receiver_created_at_idx" ON "messages" USING btree ("receiver_id","created_at");